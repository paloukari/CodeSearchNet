...
from encoders import GNN_FILM_Encoder, ConvSelfAttentionEncoder
from models import GraphModel


class GNN_FILM2TransformerModel(GraphModel):

    @classmethod
    def get_default_hyperparameters(cls) -> Dict[str, Any]:
        hypers = {}
        hypers.update({f'code_{key}': value
                       for key, value in GNN_FILM_Encoder.get_default_hyperparameters().items()})
    ...
    def __init__(self,
        ...
        super().__init__(
            hyperparameters,
            code_encoder_type=GNN_FILM_Encoder,
