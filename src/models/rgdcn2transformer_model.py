...
from encoders import RGDCN_Encoder, ConvSelfAttentionEncoder
from models import GraphModel


class RGDCN2TransformerModel(GraphModel):

    @classmethod
    def get_default_hyperparameters(cls) -> Dict[str, Any]:
        hypers = {}
        hypers.update({f'code_{key}': value
                       for key, value in RGDCN_Encoder.get_default_hyperparameters().items()})
    ...
    def __init__(self,
        ...
        super().__init__(
            hyperparameters,
            code_encoder_type=RGDCN_Encoder,
